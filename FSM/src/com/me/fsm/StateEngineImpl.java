...
public class StateEngineImpl<T extends StateImpl> implements StateEngine<T> {
    ...
    public StateEngine add(T oldState, Input input, Guard guard, Action action,
                           T newState) throws IllegalArgumentException,
    ...
    public StateEngine add(T oldState, Input input, Action action,
                           T newState) throws IllegalArgumentException,
            IllegalStateException {
        mustBeInitializing();
    ...
    public FSM makeFSM(T startState) throws IllegalStateException {
